    ...
    <div class="compositions">
      ...
      <div class="temp-list">
        ...
        >
          ...
          <div>
            <span v-if="item.property2.number"
              >특성2 {{ item.property2.name }} {{ item.property2.number }}</span
            ><span v-else>-</span>
          </div>
          <div>각인1 {{ item.socket1.name }} {{ item.socket1.number }}</div>
          <div>각인2 {{ item.socket2.name }} {{ item.socket2.number }}</div>
          <div>
            패널티 {{ item.badSocket1.name }} {{ item.badSocket1.number }}
          </div>
      ...
      <div class="sum">
        ...
        <div>
          각인
          <div
            v-for="sock of Object.keys(displaySumOfSelection.socketList)"
            :key="sock.name"
          >
        ...
        <div>
          패널티
          <div
            v-for="sock of Object.keys(displaySumOfSelection.badSocketList)"
            :key="sock.name"
          >
        ...
        <div>
          특성
          <div
            v-for="prop of Object.keys(displaySumOfSelection.propertyList)"
            :key="prop.name"
          >
